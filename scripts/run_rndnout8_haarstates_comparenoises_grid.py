# scripts/run_rndnout8_haarstates_comparenoises_grid.py
...
D = 2
NOUT = 8
NTR_VALUES = tuple(2**power for power in range(3, 14))
...
OUTPUT_DIR = PROJECT_ROOT / "data" / "rndnout8_haarstates_comparenoises_grid"
OUTPUT_FILE = OUTPUT_DIR / "_d2_nout8_noise_models_vsntr_vsN.zip"
SCAN_DIR = OUTPUT_DIR
